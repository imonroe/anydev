---
name: a11y-checker
description: Review code for accessibility compliance — WCAG 2.2 AA conformance, keyboard operability, focus management, contrast requirements, semantic HTML, ARIA usage, reflow, and forced colors support.
---
